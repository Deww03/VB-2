<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="pagePengembalianMobil.aspx.vb" Inherits="kelompok.pagePengembalianMobil" %>
                    ...
                    <div style =" width:515px; height:20px; background:silver; margin:auto; padding-right :10px; padding-left:10px;  padding-top:5px; padding-bottom:5px; margin-top:5px;">
                        <table align="center" >
                            <tr align="center" valign="middle">
                                <td  align="center" valign="middle">OLAH DATA PENGEMBALIAN MOBIL</td>
                            </tr>
                        </table>
                    </div>
                    <div style =" width:525px; height:145px; background:silver; margin:auto; padding-right :10px; padding-left:0px;  padding-top:5px; padding-bottom:5px; margin-top:5px; ">
                        <table>
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtNamaCustomer" runat="server" Width="100px" MaxLength="10"></asp:TextBox>
                                </td>
                            </tr>
                               <tr>
                                <td style="width:180px;">TANGGAL</td>
                                <td>
                                    <cc1:DatePicker ID="dtTgl" runat="server" Width="80px" PaneWidth="150px" EnableViewState="true">
                    ...
                    <div style =" width:525px; height:200px; background:silver; margin:auto; padding-right :10px; padding-left:0px;  padding-top:5px; padding-bottom:5px; margin-top:5px; overflow:auto ;  ">
                         <div style =" width:520px; height:198px; background:white; margin:auto; overflow:auto ;  ">
                            ...
                            <Columns >
                                ...
                                <asp:BoundField DataField ="NAMA_CUSTOMER" HeaderText ="NAMA CUSTOMER" ItemStyle-Width ="40px" >
                                    <HeaderStyle Wrap ="false" />
                                    <ItemStyle Wrap ="false" />
                                </asp:BoundField >
                                <asp:BoundField DataField ="TGL_PENGEMBALIAN" HeaderText ="TANGGAL" ItemStyle-Width ="150px" DataFormatString ="{0:dd MMM yyyy}" >
                                    <HeaderStyle Wrap ="false" />
                                    <ItemStyle Wrap ="false" />
                                </asp:BoundField >
