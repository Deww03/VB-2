               ...
               <div class="card-body">
                  ...
                  <div class="row">
                     <div class="col-md-6">
                        ...
                        <div class="form-group">
                           <asp:TextBox CssClass="form-control" ID="TextBox3" runat="server" placeholder="No Kontak" TextMode="Number"></asp:TextBox>
                        </div>
                     </div>
                     <div class="col-md-6">
                  ...
                  <div class="row">
                     ...
                     <div class="col-md-4">
                        <label>Kota</label>
                        <div class="form-group">
                           <asp:TextBox class="form-control" ID="TextBox6" runat="server" placeholder="Kota"></asp:TextBox>
                        </div>
                     </div>
                     <div class="col-md-4">
                  ...
                  <div class="row">
                     <div class="col-md-6">
                        ...
                        <div class="form-group">
                           <asp:TextBox class="form-control" ID="TextBox8" runat="server" placeholder="ID Anggota"></asp:TextBox>
                        </div>
                     </div>
                     <div class="col-md-6">
                  ...
                  <div class="row">
                     <div class="col">
                        <div class="form-group">
                           <asp:Button class="btn btn-success btn-block btn-lg" ID="Button1" runat="server" Text="Daftar" OnClick="Button1_Click" />
                        </div>
                     </div>
                  </div>
               </div>
